    ...
    <body>
        <div class="wrapper">
            ...
            <div class="row tabContent">
                ...
                <div class="medium-12 columns container">
                    <div class="row">
                        <h2>Talents and Special Abilites</h2>
                    </div>
                ...
                <div class="medium-12 columns container">
                    ...
                    <div class="row">
                        <div class="medium-6 columns armorContainer">
                            <div class="row header">
                                <div class="armorName">
                                    <h3>Name</h3>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="armorSummary">
                                    <input id="armor_summary" class="armorInput" type="text"/>
                                </div>
                            </div>
                        ...
                        <div class="medium-6 columns equipmentContainer">
                            <div class="row header">
                                <div class="equipmentName">
                                    <h3>Equipment</h3>
                                </div>
                                <div class="equipmentPage">
                                    <h3>Page</h3>
                                </div>
                            ...
                            <div class="row">
                                <div class="equipmentName">
                                    <input id="equipment_name" class="equipmentInput" type="text"/>
                                </div>
                                <div class="equipmentPage">
                                    <input id="equipment_page" class="equipmentInput" type="text"/>
                                </div>
                                <div class="equipmentSummary">
                                    <input id="equipment_summary" class="equipmentInput" type="text"/>
                                </div>
                            </div>

                            <div class="row">
                                <div class="addEquipment">
                                    <div class="addEquipmentButton">+</div>
                                    <p>Add Equipment</p>
                                </div>
                            </div>
                        </div>
